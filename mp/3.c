...
or whole or otherwise plagiarized the work of other students and/or persons.
    Your Full Name, DLSU ID# XXXXXXXXX
************************************************************************************/
...
/*
   Expected prerequisite.txt format (each line):
   NONE CCPROG1
   CCPROG1 CCPROG2
   ...
*/
...
/*
   Expected rooms.txt format (each line):
...
/* Checks if the student has taken a given course (by course code) */
int studentHasTaken(Student *student, char *courseCode) {
    int i, taken = 0;
